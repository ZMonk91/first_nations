...
export default function UnderConstruction() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center dark:bg-base-100 bg-gray-100 relative overflow-hidden">
      {/* Background Logo */}
      <LogoComponent width="400px" height="400px" className="absolute inset-0 object-cover z-0" />
      <div className="absolute inset-0 flex items-center justify-center opacity-5">
        <img src="/placeholder.svg?height=400&width=400" alt="Company Logo" className="w-full h-full object-contain" />
      </div>

      <div className="z-10 dark:bg-base-200 p-8 rounded-lg shadow-xl max-w-md w-full">
